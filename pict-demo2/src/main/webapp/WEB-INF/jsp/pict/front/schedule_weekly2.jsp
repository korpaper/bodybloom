    ...
    <section class="schedule-section">
        <div class="schedule-container">
            ...
            <div class="trainer-tabs" data-aos="fade-up">
                ...
                <a href="/schedule_weekly2" class="trainer-tab-link active">최재희 강사</a>
                <a href="/schedule_weekly3" class="trainer-tab-link">윤동욱 강사</a>
            </div>

            <!-- 일간/주간 탭 -->
<%--            <div class="schedule-tabs" data-aos="fade-up">--%>
<%--                <a href="/schedule_daily2" class="tab-btn">일간</a>--%>
<%--                <a href="/schedule_weekly2" class="tab-btn active">주간</a>--%>
<%--            </div>--%>
...
<script>
    ...
    function searchSchedule() {
        ...
        window.location.href = '/schedule_weekly2?targetdate=' + selectedDate;
    }
