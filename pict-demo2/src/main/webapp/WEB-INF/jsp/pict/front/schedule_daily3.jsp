    ...
    <section class="schedule-section">
        <div class="schedule-container">
            ...
            <div class="trainer-tabs" data-aos="fade-up">
                ...
                <a href="/schedule_daily3" class="trainer-tab-link active">윤동욱 강사</a>
            </div>

            <!-- 일간/주간 탭 -->
            <div class="schedule-tabs" data-aos="fade-up">
                <a href="/schedule_daily3" class="tab-btn active">일간</a>
                <a href="/schedule_weekly3" class="tab-btn">주간</a>
            </div>
...
<script>
    ...
    function searchSchedule() {
	    ...
	    updateDailyDisplay();
	    location.href= "/schedule_daily3?targetdate="+ selectedDate;
    }
